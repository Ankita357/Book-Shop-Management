//  book shop project with file handling in C++
#include<iostream>
#include<conio.h>
#include<stdio.h>
#include<fstream>
...
class Bookshop
{
	...
	void Bookshop::add_book()
	{
		...
		cout<<"\n\n\t\t\t  No. of Copies :";
		cin>>no_copy;
		file.open("F://book.txt",ios::out|ios::app);
	...
	void Bookshop::show_books()
	{
		...
		cout<<"\n\n\t\t\t\tShow All Books :";
		file.open("F://book.txt",ios::in);
		if(!file)
		cout<<"\n\n File Opening Error...";
	    else
	    {
	    	cout<<"\n\n Book ID    Book Name    Author    No. of Copies\n\n";
	    	file>>b_id>>b_name>>a_name>>no_copy;
	    	while(!file.eof())
	    	{
  ...
  void Bookshop::check_book()
  {
	...
	void Bookshop::update_book()
	{
		...
		cout<<"\n\n\t\t\t\tUpdate Book Record";
		file1.open("F://book1.txt",ios::app|ios::out);
		file.open("F://book.txt",ios::in);
		if(!file)
		cout<<"\n\n File Opening Error...";
		else
